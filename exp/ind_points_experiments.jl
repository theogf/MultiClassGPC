...
doSharedPrior = args["shared_prior"]
...
#All Parameters
BXGPMCParam = XGPMCParameters(main_param=main_param,independent=!doSharedPrior)
SXGPMCParam = XGPMCParameters(Stochastic=doStochastic,Sparse=true,ALR=true,main_param=main_param,independent=!doSharedPrior)
